...
parser.add_argument("--degset", default="./datasets/Deraining/input/", type=str, help="degraded data")
parser.add_argument("--tarset", default="./datasets/Deraining/target/", type=str, help="target data")
