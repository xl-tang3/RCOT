...
# parser.add_argument("--model", default="./checkpoint/model_SR__300_0.1.pth", type=str, help="model path")
# parser.add_argument("--save", default="./results/SR/OUT/", type=str, help="savepath, Default: results")
# parser.add_argument("--saveres", default="./results/SR/RES/", type=str, help="savepath, Default: residual")
# parser.add_argument("--savetar", default="./results/SR/TAR/", type=str, help="savepath, Default: targets")
# parser.add_argument("--degset", default="./datasets/SR/testLR/", type=str, help="degraded data")
# parser.add_argument("--tarset", default="./datasets/SR/testHR/", type=str, help="target data")

parser.add_argument("--model", default="./checkpoint/model_Deraining__30_2.0.pth", type=str, help="model path")
